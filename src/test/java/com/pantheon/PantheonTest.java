...
//                // Windows
    ...
    public void PantheonPageTitle(String type, String browser, String version, String os, String device, Method method) throws Exception {

        WebDriver driver = createDriver(type, browser, version, os, device, method.getName());
        driver.get("https://pantheon.io/");
        assertEquals(driver.getTitle(), "WebOps SaaS Platform for High Impact Websites | Pantheon");
    }
    @Test(dataProvider = "hardCodedBrowsers")
    public void PantheonWhy(String type, String browser, String version, String os, String device, Method method) throws Exception {

        WebDriver driver = createDriver(type, browser, version, os, device, method.getName());
        driver.get("https://pantheon.io/");
        driver.findElement(By.linkText("Why Pantheon")).click();
    }
